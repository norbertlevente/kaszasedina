...
const Banner = () => {
  return (
    <div className="relative isolate hidden sm:flex items-center justify-center gap-x-6 overflow-hidden bg-primary px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 w-full">
        <p className="text-sm leading-6 text-white flex items-center gap-x-2">
          <strong className="font-semibold">Telefon: +36 70 333 9663</strong>
